...
export default function KDSScreen() {
  ...
  // Re-fetch immediately whenever filter tab changes (but we now have all items, so this is instant)

  useEffect(() => {

    // Commenting out the fetch since we already have all items in state

    // Just changing the filter variable is enough to update displayItems
